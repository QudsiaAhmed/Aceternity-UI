  ...
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      <Row>
        ...
        <KBtn>
          <div className="h-4 w-4 rounded-full bg-gradient-to-b from-20% from-neutral-800 to-neutral-500 mx-auto mb-1" />
        </KBtn>
      </Row>
      <Row>
        <KBtn className="row-span-2">
          <IconCommand />
        </KBtn>
        <KBtn
          childrenClassName="items-start"
        ...
        >
          <span
            className="absolute bottom-0 left-0 pl-1"
            style={{
              fontSize: "6px",
            }}
          >
        ...
        >
          <span className="text-[8px]">caps lock</span>
        </KBtn>
        <KBtn className="row-span-2" childrenClassName="items-start">
          <div className="h-[6px]">
            <IconWorld />
          </div>
          <span>shift</span>
...
export const KBtn = ({ className, childrenClassName, style, children }) => {
  return (
    <div
      className={`h-8 w-8 bg-gray-700 m-1 rounded-md flex items-center justify-center cursor-pointer text-white text-xs ${
        className || ""
      }`}
      style={style}
    >
  ...
  return (
    ...
    >
      {[...Array(rows * columns)].map((_, i) => (
        <div key={i} className="bg-black h-1 w-1 m-0.5 rounded-full"></div>
      ))}
    </div>
  );
};
...
export const AceternityLogo = () => {
  return <div className="text-xl font-bold">Aceternity</div>;
};
